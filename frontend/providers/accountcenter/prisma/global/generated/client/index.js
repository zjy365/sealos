...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/honsunrise/Projects/project-v/sealos/frontend/providers/accountcenter/prisma/global/generated/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/global/generated/client",
    "global/generated/client",
  ]
...
path.join(process.cwd(), "prisma/global/generated/client/libquery_engine-darwin-arm64.dylib.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-linux-musl-openssl-3.0.x.so.node");
path.join(process.cwd(), "prisma/global/generated/client/libquery_engine-linux-musl-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/global/generated/client/schema.prisma")
