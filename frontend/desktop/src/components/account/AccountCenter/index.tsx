...
const AccountCenter = forwardRef<AccountCenterRef, Omit<IconButtonProps, 'aria-label'>>(
  (props, ref) => {
    ...
    const providerState = useMemo(() => {
      ...
      const state = (infoData.data?.oauthProvider || []).reduce(
        (pre, cur) => {
          ...
          if (providerType === 'PHONE' || providerType === 'EMAIL')
            pre[providerType].id = providerId;
          pre.total += 1;
          return pre;
        },
        {
...
AccountCenter.displayName = 'AccountCenter';
