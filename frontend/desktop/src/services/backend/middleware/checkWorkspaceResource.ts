...
// import { InitUserParams, initUserParamsSchema } from '@/schema/auth';
...
// export const filterInitUser = createMiddleware<void, InitUserParams>(
//   async ({ req, res, next, ctx }) => {
//     const result = initUserParamsSchema.safeParse(req.body);
//     if (!result.success) {
//       jsonRes(res, {
