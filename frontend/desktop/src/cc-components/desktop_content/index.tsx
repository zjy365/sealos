...
import AppWindow from '@/cc-components/app_window';
import useDriver from '@/cc-components/task/useDriver';
...
const FloatButton = dynamic(() => import('@/cc-components/floating_button'), { ssr: false });
